...
class Memes {
  ...
  createMeme(){
    ...
    this.$context.fillText(bottomText,this.$canvas.width/2, this.$canvas.height*(5/100));
  ...
  loadImage() 
  {
    ...
    {let reader = new FileReader();
      reader.onload= () => {this.image= new Image();this.image.onload= () => {this.createMeme();};this.image.src= reader.result;};
